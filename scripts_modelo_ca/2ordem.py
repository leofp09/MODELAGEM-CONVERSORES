...
print(f'.param A11={A[0,0]:.12g} A12={A[0,1]:.12g}')
print(f'.param A21={A[1,0]:.12g} A22={A[1,1]:.12g}')
print(f'.param B11={B[0,0]:.12g} B21={B[1,0]:.12g}')
print(f'.param C11={C[0,0]:.12g} C12={C[0,1]:.12g}')
print(f'.param D11={E[0,0]:.12g}')
print(f'.param IC1={X[0,0]:.12g} IC2={X[1,0]:.12g}')